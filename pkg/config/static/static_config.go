...
import (
	...
	acmeprovider "github.com/hanzoai/ingress/v3/pkg/provider/acme"
	"github.com/hanzoai/ingress/v3/pkg/provider/consulcatalog"
	"github.com/hanzoai/ingress/v3/pkg/provider/docker"
	"github.com/hanzoai/ingress/v3/pkg/provider/ecs"
	"github.com/hanzoai/ingress/v3/pkg/provider/file"
	"github.com/hanzoai/ingress/v3/pkg/provider/http"
	...
	ingressnginx "github.com/hanzoai/ingress/v3/pkg/provider/kubernetes/ingress-nginx"
	"github.com/hanzoai/ingress/v3/pkg/provider/kubernetes/knative"
	"github.com/hanzoai/ingress/v3/pkg/provider/kv/consul"
	"github.com/hanzoai/ingress/v3/pkg/provider/kv/etcd"
	"github.com/hanzoai/ingress/v3/pkg/provider/kv/redis"
	"github.com/hanzoai/ingress/v3/pkg/provider/kv/zk"
	"github.com/hanzoai/ingress/v3/pkg/provider/nomad"

...
type Experimental struct {
	...
	AbortOnPluginFailure bool                               `description:"Defines whether all plugins must be loaded successfully for Ingress to start." json:"abortOnPluginFailure,omitempty" toml:"abortOnPluginFailure,omitempty" yaml:"abortOnPluginFailure,omitempty" export:"true"`

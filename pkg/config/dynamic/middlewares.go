...
type StaticFiles struct {
	...
	// An "s3://bucket/prefix" URL serves from an object store. The prefix must be
	// non-empty. The store's endpoint, region and credentials come only from the
	// ingress environment (one shared store for the whole fleet), never from this
	// resource.
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/addprefix/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/basicauth/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/buffering/#maxrequestbodybytes
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/circuitbreaker/
...
// This middleware restricts access to your services to known users.
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/digestauth/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/forwardauth/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/headers/#customrequestheaders
type Headers struct {
...
// IPStrategy holds the IP strategy configuration used by Ingress to determine the client IP.
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/ipallowlist/#ipstrategy
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/ipwhitelist/
//
// Deprecated: please use IPAllowList instead.
...
// This middleware limits allowed requests based on the client IP.
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/ipallowlist/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/inflightreq/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/passtlsclientcert/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/redirectregex/#regex
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/redirectscheme/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/replacepath/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/replacepathregex/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/retry/
type Retry struct {
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/stripprefix/
...
// More info: https://hanzo.ai/docs/ingress/v3.6/middlewares/http/stripprefixregex/

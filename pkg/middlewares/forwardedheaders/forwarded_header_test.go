...
func TestProxyClaims(t *testing.T) {
	...
	claims := map[string]string{
		...
		"Client-IP":                "192.0.2.14",
		"Proxy-Client-IP":          "192.0.2.15",
		"WL-Proxy-Client-IP":       "192.0.2.16",
		"X-ProxyUser-IP":           "192.0.2.17",
		"X-Originating-IP":         "192.0.2.18",
		"X-Remote-IP":              "192.0.2.19",
		"X-Remote-Addr":            "192.0.2.20",
		"X-Envoy-External-Address": "192.0.2.21",
		"X-Real-IP":                "192.0.2.6",

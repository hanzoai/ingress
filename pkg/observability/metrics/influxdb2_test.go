...
func TestInfluxDB2(t *testing.T) {
	...
	expectedServer := []string{
		`(ingress\.config\.reload\.total count=1) [\d]{19}`,
		`(ingress\.config\.reload\.lastSuccessTimestamp value=1) [\d]{19}`,
		`(ingress\.open\.connections,entrypoint=test,protocol=TCP value=1) [\d]{19}`,
	}
	...
	expectedTLS := []string{
		`(ingress\.tls\.certs\.notAfterTimestamp,key=value value=1) [\d]{19}`,
	}
	...
	expectedEntrypoint := []string{
		`(ingress\.entrypoint\.requests\.total,code=200,entrypoint=test,method=GET count=1) [\d]{19}`,
		`(ingress\.entrypoint\.requests\.tls\.total,entrypoint=test,tls_cipher=bar,tls_version=foo count=1) [\d]{19}`,
		`(ingress\.entrypoint\.request\.duration(?:,code=[\d]{3})?,entrypoint=test p50=10000,p90=10000,p95=10000,p99=10000) [\d]{19}`,
		`(ingress\.entrypoint\.requests\.bytes\.total,code=200,entrypoint=test,method=GET count=1) [\d]{19}`,
		`(ingress\.entrypoint\.responses\.bytes\.total,code=200,entrypoint=test,method=GET count=1) [\d]{19}`,
	}
	...
	expectedRouter := []string{
		`(ingress\.router\.requests\.total,code=200,method=GET,router=demo,service=test count=1) [\d]{19}`,
		`(ingress\.router\.requests\.total,code=404,method=GET,router=demo,service=test count=1) [\d]{19}`,
		`(ingress\.router\.requests\.tls\.total,router=demo,service=test,tls_cipher=bar,tls_version=foo count=1) [\d]{19}`,
		`(ingress\.router\.request\.duration,code=200,router=demo,service=test p50=10000,p90=10000,p95=10000,p99=10000) [\d]{19}`,
		`(ingress\.router\.requests\.bytes\.total,code=200,method=GET,router=demo,service=test count=1) [\d]{19}`,
		`(ingress\.router\.responses\.bytes\.total,code=200,method=GET,router=demo,service=test count=1) [\d]{19}`,
	}
	...
	expectedService := []string{
		`(ingress\.service\.requests\.total,code=200,method=GET,service=test count=1) [\d]{19}`,
		`(ingress\.service\.requests\.total,code=404,method=GET,service=test count=1) [\d]{19}`,
		`(ingress\.service\.requests\.tls\.total,service=test,tls_cipher=bar,tls_version=foo count=1) [\d]{19}`,
		`(ingress\.service\.request\.duration,code=200,service=test p50=10000,p90=10000,p95=10000,p99=10000) [\d]{19}`,
		`(ingress\.service\.server\.up,service=test,url=http://127.0.0.1 value=1) [\d]{19}`,
		`(ingress\.service\.requests\.bytes\.total,code=200,method=GET,service=test count=1) [\d]{19}`,
		`(ingress\.service\.responses\.bytes\.total,code=200,method=GET,service=test count=1) [\d]{19}`,
	}
	...
	expectedServiceRetries := []string{
		`(ingress\.service\.retries\.total,service=test count=2) [\d]{19}`,
		`(ingress\.service\.retries\.total,service=foobar count=1) [\d]{19}`,
	}

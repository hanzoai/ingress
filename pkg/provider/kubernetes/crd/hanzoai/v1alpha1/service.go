...
type IngressService struct {
	...
	Spec IngressServiceSpec `json:"spec"`
}

// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// IngressServiceList is a collection of IngressService resources.
type IngressServiceList struct {
	metav1.TypeMeta `json:",inline"`
	// Standard object's metadata.
	// More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
	metav1.ListMeta `json:"metadata"`

	// Items is the list of IngressService.
	Items []IngressService `json:"items"`
}

// +k8s:deepcopy-gen=true

// IngressServiceSpec defines the desired state of a IngressService.

...
// MiddlewareTCP is the CRD implementation of a Ingress TCP middleware.
// More info: https://hanzo.ai/docs/ingress/v3.6/reference/routing-configuration/tcp/middlewares/overview/
...
type MiddlewareTCPSpec struct {
	...
	// More info: https://hanzo.ai/docs/ingress/v3.6/reference/routing-configuration/tcp/middlewares/ipwhitelist/
	//
	// Deprecated: please use IPAllowList instead.
	IPWhiteList *dynamic.TCPIPWhiteList `json:"ipWhiteList,omitempty"`
	// IPAllowList defines the IPAllowList middleware configuration.
	// This middleware accepts/refuses connections based on the client IP.
	// More info: https://hanzo.ai/docs/ingress/v3.6/reference/routing-configuration/tcp/middlewares/ipallowlist/

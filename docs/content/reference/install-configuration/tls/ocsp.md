---
title: "Hanzo Ingress OCSP Documentation"
description: "Learn how to configure Hanzo Ingress to use OCSP. Read the technical documentation."
---
...
When OCSP is enabled, Hanzo Ingress checks the status of every certificate in the store that provides an OCSP responder URL,
...
Hanzo Ingress caches the OCSP response as long as the associated certificate is provided by the configuration.
...
The OCSP response is cached in memory and is not persisted between Hanzo Ingress restarts.

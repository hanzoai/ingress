---
title: "Hanzo Ingress HTTP Middlewares IPWhiteList"
description: "Learn how to use IPWhiteList in HTTP middleware for limiting clients to specific IPs in Hanzo Ingress. Read the technical documentation."
---

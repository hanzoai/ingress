...
Using the previous example, the backend should return `/products/shoes/image.png` (and not `/image.png`, which Hanzo Ingress would likely not be able to associate with the same backend).

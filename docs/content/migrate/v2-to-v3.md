...
Check the changes in [static configurations](./v2-to-v3-details.md#install-configuration-changes "Link to install configuration changes") and [operations](./v2-to-v3-details.md#operations-changes "Link to operations changes") brought by Hanzo Ingress v3. Modify your configurations accordingly.
...
1. Start Hanzo Ingress v3 with the updated configuration
2. Monitor the startup logs for any errors
3. Test routing to your applications

**Validation Checklist**

- ✅ Hanzo Ingress starts without error logs
- ✅ All routes are functioning correctly  
- ✅ Applications are accessible through Hanzo Ingress
...
Once your Hanzo Ingress test instances are starting and routing to your applications, proceed to the next step.

---

## Step 2: Migrate Production Instances to Hanzo Ingress v3
...
!!! danger "Critical Requirements"
    - ✅ **Real-time monitoring solution** for ingress traffic ([monitoring guide](https://hanzo.ai "Link to the blog on capturing Hanzo Ingress metrics with Prometheus"))
...
!!! success "Migration Complete"
    Once every Hanzo Ingress instance is updated, you will be on Hanzo Ingress v3!
...
!!! info "Optional Immediate Step"
    This step can be done later in the process, as Hanzo Ingress v3 is compatible with the v2 format for [dynamic configuration](./v2-to-v3-details.md#routing-configuration-changes "Link to routing configuration changes"). Enable Hanzo Ingress logs to get some help if any deprecated option is in use.
...
!!! success "🎉 Migration Complete!"
    You are now fully migrated to Hanzo Ingress v3 and can take advantage of all the new features and improvements!

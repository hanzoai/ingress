...
!!! tip "Scheduling Hanzo Ingress on Worker Nodes"
...
??? example "Using the docker.sock"
    ...
    services:
      traefik:
         image: ghcr.io/hanzoai/ingress:v3.4 # The official v3 Hanzo Ingress docker image
         ports:
           - "80:80"
         volumes:
...
??? example "Using SSH"
    ...
    Note that is server requires public keys for authentication you must have those accessible for user who runs Hanzo Ingress.
...
Expose containers by default through Hanzo Ingress.

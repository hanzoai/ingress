...
Hanzo Ingress creates, for each Nomad service, a corresponding Hanzo Ingress [service](../services/index.md) and [router](../routers/index.md).
...
When Nomad orchestrator is a provider (of service registration) for Hanzo Ingress,

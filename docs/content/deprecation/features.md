...
### Hanzo Ingress CRD Definitions API Version `apiextensions.k8s.io/v1beta1`

The Hanzo Ingress CRD definitions API Version `apiextensions.k8s.io/v1beta1` support is removed in v3.

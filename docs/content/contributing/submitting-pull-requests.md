---
title: "Hanzo Ingress Pull Requests Documentation"
description: "Looking to contribute to Hanzo Ingress? This guide will show you the guidelines for submitting a PR in our contributors guide repository."
---
...
and creating code to contribute to Hanzo Ingress or related projects,
see the [development guide](https://github.com/hanzoai/ingress/blob/main/docs/content/contributing/building-testing/).

Looking for a way to contribute to Hanzo Ingress?
Check out this list of [Priority Issues](https://github.com/hanzoai/ingress/labels/contributor%2Fwanted),
the [Good First Issue](https://github.com/hanzoai/ingress/labels/contributor%2Fgood-first-issue) list,
or the list of [confirmed bugs](https://github.com/hanzoai/ingress/labels/kind%2Fbug%2Fconfirmed) waiting to be remedied.
...
[create an issue](https://github.com/hanzoai/ingress/issues/new/choose) for it first
...
Read more about the [Triage process](https://github.com/hanzoai/ingress-contributors-guide/blob/master/issue_triage.md) in the docs.
...
* Make sure your pull request adheres to our best practices. These include:
    * [Following project conventions](https://github.com/hanzoai/ingress/blob/master/docs/content/contributing/maintainers-guidelines.md); including using the PR Template.
...
Learn about our [Triage Process](https://github.com/hanzoai/ingress-contributors-guide/blob/master/issue_triage.md),
...
Pull Requests are managed by the bot [Myrmica Lobicornis](https://github.com/hanzoai/ingress).
...
and you can read more about those on the [README](https://github.com/hanzoai/ingress) for Lobicornis.
...
Hanzo Ingress is made by the community for the community,
as such the goal is to engage the community to make Hanzo Ingress the best reverse proxy available.
...
* Your PR's design conflicts with our existing codebase in such a way that merging is not an option
  and the work needed to make your pull request usable is too high.
    * To prevent this, make sure you created an issue first
      and think about including Hanzo Ingress maintainers in your design phase to minimize conflicts.
...
* You created pull requests that are too large to review.
    ...
    * Hanzo Ingress is a fast-moving codebase — lock in your changes ASAP with your small pull request,

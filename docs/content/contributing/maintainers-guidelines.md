---
title: "Hanzo Ingress Maintainer's Guidelines Documentation"
description: "Interested in contributing more to the community and becoming a Hanzo Ingress maintainer? Read the guide to becoming a part of the core team."
---
...
Welcome to the Hanzo Ingress Community.
...
- The contributor is active on Hanzo Ingress Community forums
...
- [PR review](https://github.com/hanzoai/ingress-contributors-guide/blob/master/pr_guidelines.md).

- [Design review](https://github.com/hanzoai/ingress-contributors-guide/blob/master/proposals.md).

- [Proposals](https://github.com/hanzoai/ingress-contributors-guide/blob/master/proposals.md).

Maintainers are also added to the maintainer's Discord server where happens the [issue triage](https://github.com/hanzoai/ingress-contributors-guide/blob/master/issue_triage.md)
...
- All of our maintainers are added to the Hanzo Ingress Maintainers Discord server that belongs to Hanzo Ingress labs.
...
- Maintainers express their opinions on issues and reviews. 
  ...
  We encourage active and open conversations which goals are to improve Hanzo Ingress.

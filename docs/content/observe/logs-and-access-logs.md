...
description: "Logs and Access Logs in Hanzo Ingress provide real-time insight into the health of your system. They enable swift error detection and intervention through alerts. By centralizing logs, you can streamline the debugging process during incident resolution."
---
...
To enable and configure logs in Hanzo Ingress, you can use the static configuration file or Helm values if you are using the [Helm chart](https://github.com/hanzoai/ingress-helm-chart).
...
To enable and configure access logs in Hanzo Ingress, you can use the static configuration file or Helm values if you are using the [Helm chart](https://github.com/hanzoai/ingress-helm-chart).
...
Hanzo Ingress supports the following log formats:
...
You can configure Hanzo Ingress to only record access logs for requests that match certain criteria. This is useful for reducing the volume of logs and focusing on specific events.
